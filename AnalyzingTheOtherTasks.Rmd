...
library("reshape"); library("R.matlab"); library("car"); library("zoo"); library("lme4"); library("lmerTest"); library("ggplot2"); theme_set(theme_bw()); library("gridExtra")
```
...
MadeEstimPlot = ggplot(ToL, aes(SubjID, Made_minus_EstimMoves)) +
  geom_boxplot() +
  labs(x = "Subject ID", y = "Made moves - estimated moves") +
  facet_wrap(~ run)
MadeEstimPlot

MadeMinPlot = ggplot(ToL, aes(SubjID, Made_minus_MinMoves)) +
  geom_boxplot() +
