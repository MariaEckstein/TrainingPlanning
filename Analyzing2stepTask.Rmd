...
if (preprocess_data) {
  ...
  if (maria_only) {
    TS_file_dir = file.path(model_dir, "Results/flat_models")
...
a2_dat = subset(all_genrec, select = c("SubjID", "run", "model", "hier", "n_par", "a2", "model_name"))
a2_dat = reshape(a2_dat, timevar = "model", direction = "wide", idvar = c("SubjID", "run", "hier", "n_par", "model_name"))

p_dat = subset(all_genrec, select = c("SubjID", "run", "model", "hier", "n_par", "p", "model_name"))
p_dat = reshape(p_dat, timevar = "model", direction = "wide", idvar = c("SubjID", "run", "hier", "n_par", "model_name"))

w_dat = subset(all_genrec, select = c("SubjID", "run", "model", "hier", "n_par", "w", "model_name"))
w_dat = reshape(w_dat, timevar = "model", direction = "wide", idvar = c("SubjID", "run", "hier", "n_par", "model_name"))
