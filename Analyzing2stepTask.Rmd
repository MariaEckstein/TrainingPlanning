...
mf_vs_rest = c(1, 1, -2)
co_vs_mb = c(-1, 1, 0)
contrasts(mod_dat$training_s1) = cbind(mf_vs_rest, mb_vs_mf)
...
### Should run another model on the changes!
# dw12 ~ training_s1
```
...
# Overall
ggplot(ts_plot_dat, aes(training_s1, dw12)) +
...
ggplot(ts_plot_dat, aes(training_s1, dw13)) +
  stat_summary(geom = "bar", fun.data = mean_cl_normal, fun.args = list(mult = 1)) +
  # geom_point(alpha = .2, position = "jitter") +
  stat_summary(geom = "pointrange", fun.data = mean_cl_normal, fun.args = list(mult = 1))
