...
gg_w_flat_hier = ggplot(w_molten, aes(w.klaus_flat_4, w.klaus_hier_4)) +
  geom_point() +
...
gg_w_k_m = ggplot(w_molten, aes(w.klaus_flat_4, w.l0)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_w_k_m
...
gg_w_hier_46 = ggplot(w_molten, aes(w.klaus_flat_4, w.klaus_flat_6)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_w_hier_46

gg_w_hier_46 = ggplot(w_molten, aes(w.klaus_hier_4, w.klaus_hier_6)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_w_hier_46

gg_w_hier_47 = ggplot(w_molten, aes(w.klaus_hier_4, w.klaus_hier_7)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_w_hier_47

gg_w_hier_67 = ggplot(w_molten, aes(w.klaus_hier_6, w.klaus_hier_7)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_w_hier_67
...
gg_p_flat_hier = ggplot(p_molten, aes(p.klaus_flat_4, p.klaus_hier_4)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_p_flat_hier

gg_p_k_m = ggplot(p_molten, aes(p.klaus_flat_4, p.l0)) +
  geom_point() +
  geom_smooth(method = "lm")
gg_p_k_m
...
gg_a_flat_hier = ggplot(a_molten, aes(a1.klaus_flat_4, a1.klaus_hier_4)) +
  geom_point() +
  geom_smooth(method = "lm") +
  coord_cartesian(xlim = c(0, 1), ylim = c(0, 1))
gg_a_flat_hier

gg_a_k_m = ggplot(a_molten, aes(a1.klaus_flat_4, a1.l0)) +
  geom_point() +
  geom_smooth(method = "lm") +
  coord_cartesian(xlim = c(0, 1), ylim = c(0, 1))
gg_a_k_m
...
selected_parameter_dat = subset(ts_params_molten,
                                params %in% c("hyb", "l0", "klaus_hier_4", "klaus_flat_4", "klaus_hier_6", "klaus_flat_6") & parameter %in% c("a1", "a2", "b1", "b2", "p", "k", "w"),
...
selected_parameter_dat = subset(selected_parameter_dat, params == "l0")
...
```{r Training performance -> MB?, echo = F}
# Prepare data
ts_plot_dat = subset(ts_params, params %in% c("l0", "klaus_hier_4", "klaus_flat_4"),
...
```{r Long-term training effects, echo = F}

# Run3, w of mbmb vs mbmf people: 
...
```{r Regression model about that, echo = F}
