...
summary(rel_BIC)
rel_BIC_molten = melt(subset(rel_BIC, select = -c(BIC.a1b1_nok, BIC.a1b1, BIC.hyb, BIC.l0, BIC.l1, BIC.mb, BIC.mf, BIC.nok_l1, BIC.nok_l1, BIC.nok_mb, BIC.nok_mf, BIC.nok, BIC.nop, BIC.nopk)),
                      id.vars = c("SubjID", "session", "run", "training", "training_s1"))

# Plot relative BICs
gg_rel_BIC = ggplot(rel_BIC_molten, aes(variable, -value)) +
  geom_point(position = "jitter", alpha = 0.2) +
  stat_summary(fun.data = mean_cl_normal, geom = "pointrange") +
