classdef ParameterFitting
    ...
    methods
        ...
        function obj = ParameterFitting(fit_model, n_fmincon_iterations)
        ...
        function [fit_params, function_value] = minimize_NLL(self, Agent, sim_data, common)
            ...
            [fit_params, function_value] = find_params_that_minimize_NLL(object_fun, self.par0, self.pmin, self.pmax, self.n_fmincon_iterations);
        end
