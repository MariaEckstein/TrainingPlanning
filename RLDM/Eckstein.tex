...
%Furthermore, in the model-based and model-free groups (but not in control), we observed a pattern unaccounted for by either learning strategy: participants avoided actions that had previously been followed by unexpected outcomes. [AC: I'm not sure this should go in the abstract. It's hard to make it a single story with this. But feel free to leave it if you feel it's important]
...
% Did you check in other 2-step papers if they have main effects of transition as we observe here? -> No!
