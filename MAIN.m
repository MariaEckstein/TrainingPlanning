...
if strcmp(sim_model, 'mf')
    sim_par = [-1 -1 -1 -1 -1 0];   % a1 a2 b1 b2 l w
elseif strcmp(sim_model, 'mb')
    sim_par = [ 0 -1 -1 -1  0 1];   % a1 a2 b1 b2 l w
elseif strcmp(sim_model, 'hyb')
    sim_par = -1 * ones(1, 6);   % a1 a2 b1 b2 l w
end
...
if fit_data
    ...
    if strcmp(fit_model, 'mf')
        fit_par = [-1 -1 -1 -1 -1 0];   % a1 a2 b1 b2 l w
    elseif strcmp(fit_model, 'mb')
        fit_par = [ 0 -1 -1 -1  0 1];   % a1 a2 b1 b2 l w
    elseif strcmp(fit_model, 'hyb')
        fit_par = -1 * ones(1, 6);   % a1 a2 b1 b2 l w
    end
