...
switch sim_data
    case 'sim'
        ...
        sim_par = model_parameters(model_ID(data_type),:);  % Which parameters will be fitted (-1) and which are fixed by me (values)?
        ...
        save(['data_' data_type '_agents.mat'], 'Data')
        
    case 'load'
        load(['data_' data_type '_agents.mat'])
